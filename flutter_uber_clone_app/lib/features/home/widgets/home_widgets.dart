                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.all(Radius.circular(AppSizes.padding10)),
                        ),
                        child: Center(
                          child: Text('Book a ride', style: TextStyle(fontSize: AppSizes.fontMedium, color: AppColors.white),),
                        ),
                      ),
                    )
                  ],
